        ...
        <div class="container mx-auto h-full" v-motion :initial="{
            ...
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    ...
                    <button
                        class="btn btn-md text-white bg-accent hover:bg-light-secondary hover:text-light-tail-500 dark:hover:bg-dark-secondary dark:hover:text-dark-navy-100 md:btn-lg transition-all">
                        Work with me
                    </button>
                    <div class="pt-12">
                        <h5
