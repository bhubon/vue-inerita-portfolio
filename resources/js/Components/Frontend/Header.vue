...
onMounted(() => {
  window.addEventListener("scroll", () => {
    return window.scrollY > 10 ? setScrollBg(true) : setScrollBg(false);
  });
});
</script>
...
<template>
    <nav class="w-full fixed z-20 border-gray-200 px-2 sm:px-4 py-2.5 rounded" :class="{
        'bg-light-primary dark:bg-white': scrollBg,
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto" bis_skin_checked="1">
            <a href="https://laraveller.com/" class="flex items-center">
                <img src="https://thedevnil.com/wp-content/uploads/2022/10/n-1.png" class="mr-3 h-6 sm:h-9" alt="Laraveller Logo" />
                <span class="
              self-center
              text-xl
              font-semibold
